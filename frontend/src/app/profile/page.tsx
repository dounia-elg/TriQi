            ...
            <main className="min-h-screen pt-28 pb-24 px-6 md:px-10" style={{ background: 'var(--bg)' }}>
                <div className="max-w-6xl mx-auto space-y-8">
                    ...
                    <div className="flex justify-between items-center px-2">
                        <Link href="/" className="flex items-center gap-2 text-sm font-semibold text-(--muted) hover:text-(--primary) transition-colors">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-10 items-start">
                        ...
                        <aside className="space-y-6">
                            ...
                            {/* Profile Card */}
                            <div
                                className="relative overflow-hidden rounded-4xl p-8 text-center border shadow-sm"
                            ...
                            >
                                ...
                                <p className="mt-2 text-sm font-medium text-(--muted) break-all px-2">
                                    {profile?.email}
                                </p>

                                <div className="mt-8 pt-8 border-t border-(--blue)/20 space-y-3">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                {/* Academic Card */}
                                <div className="bg-white rounded-4xl p-8 border border-(--border) shadow-sm">
                                    <div className="flex items-center gap-3 mb-8">
                                        <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-(--tint-pink) text-(--secondary)"><GraduationCap size={20} /></div>
                                ...
                                <div className="bg-white rounded-4xl p-8 border border-(--border) shadow-sm">
                                    <div className="flex items-center gap-3 mb-8">
                                        <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-(--tint-blue) text-(--primary)"><Settings size={20} /></div>
                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                <div className="flex-1 bg-white rounded-4xl p-8 border border-(--border) shadow-sm">
                                    <div className="flex items-center gap-3 mb-4">
                                        <Shield size={18} className="text-(--primary)" />
                                        <h3 className="font-bold text-[10px] uppercase tracking-widest text-(--dim)">Security & Privacy</h3>
                                    </div>
                                    <p className="text-sm text-(--muted) leading-relaxed">Your data is secured with AES-256 encryption. We only share it with orientation advisors after your explicit consent.</p>
                                </div>
