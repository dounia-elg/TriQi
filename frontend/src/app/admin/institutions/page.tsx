        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            {institutions.length === 0 ? (
              ...
              <tr key={inst._id} className="border-b border-(--border) last:border-0 hover:bg-[#F9FAFB]">
                <td className="px-6 py-4 font-bold text-[#1E293B]">
                  {inst.name}
                  <div className="text-xs font-normal text-[#8a9ab1] mt-1 truncate max-w-50">{inst.website || 'No website'}</div>
                </td>
          ...
          <div className="bg-white rounded-4xl w-full max-w-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2 flex items-center gap-3 bg-[#F9FAFB] p-4 rounded-2xl border border-(--border)">
            ...
            <div className="p-6 border-t border-(--border) bg-[#F0F8FF] flex justify-end gap-3 rounded-b-4xl">
              ...
              <button type="submit" onClick={handleSubmit} disabled={saving || !formData.name || !formData.country || !formData.city} className="btn-primary flex items-center gap-2 disabled:opacity-50">
